...
#define DeviceName "ZappyGenuino"

const char host[] = "tic2017team030.iot.telstra.com";
const char tenant[] = "tic2017team030";
const char username[] = "ZappyGenuino";
const char password[] = "B3_0ur_Lord!";
const char appkey[] = ""; 
