...
<header class="w3-display-container w3-center">
  ...
  <div style=width:inherit; class="mySlides w3-animate-opacity">
    ...
    <img class="w3-image" src="Cranberry Logo_3_PagePoster_2.jpg" alt="Image 1" width=100%s height="1000">
...
<div class="w3-padding-32 w3-light-grey">
  <div class="w3-row-padding">
    <div class="w3-col 14 m12">
      <h1 class="w3-jumbo w3-text-center"><b>Predator</b></h1> <!-- Place the header here-->
      <h1 class="w3-xxxlarge w3-text-green w3-text-center"><b>Pest Surveillance System for the Public</b></h1> <!-- Place the sub-header here-->
...
<div class="w3-padding-small w3-light-grey">
  <div class="w3-row-padding">
    <div class="w3-col 14 m8">
      ...
      <!-- Content in here-->
      <p><span class="w3-xlarge">Use it like a poo.</span> Best way to enforce democracy</p>
    </div>
        <!-- Content end here-->
